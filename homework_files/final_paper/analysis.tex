...
In the presented transcript, the symbol [...] indicates where we have removed portions of the transcript in order to focus on the parts of the transcripts that are integral to our analysis. 
...
The student appears to be trying to call func4 before calling func1.
...
He considers ways to call func4 without any arguments, he finishes his previous sentence with,
...
He appears to understand that func4 is passed as an argument, and the semantics of doing so.
...
\end{tabular} \\
From this statement, we think the student is able to relate the code concept of a class to the domain concept of a game of Connect 4. \\
...
This lack of experience leads him to question what the data structure self.board is actually represented as.
He lists possible representations as a list of lists (dynamically allocated) or and array of arrays (statically allocated). He is also not clear on exactly how many secondary 'arrays' are created. 
This prevents him from mapping the data member construct to the physical representation of a Connect 4 board. \\
...
\end{tabular}\\
In line T6, the student appears to finally understands how the data structure of the board works, both in how it is initialized and how it changes through the drop function. 
